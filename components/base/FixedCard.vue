<template>
  <ClientOnly>
    <div :class="['fixed-card w-full transition-colors duration-300 ease-in-out border-border rounded-lg',
      ...
      <div
        ...
        <slot name="CardInfo" class="md:max-w-[300px]">
          <DevOnly>
...
const actualHeaderHeight = computed(() => isMobile.value ? props.headerHeight.mobile : props.headerHeight.desktop)
const actualFooterHeight = computed(() => isMobile.value ? props.footerHeight.mobile : props.footerHeight.desktop)
const actualOtherElementsHeight = computed(() => isMobile.value ? props.otherElementsHeight.mobile : props.otherElementsHeight.desktop)
