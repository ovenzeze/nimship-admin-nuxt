<template>
  <div :class="[
    'px-3 py-1 md:py-10 flex flex-col justify-center transition-all duration-300',
    ...
    <div
      class="relative flex-1 text-sm  font-semibold text-foreground/90 group-hover:text-foreground md:group-hover:text-base content-center transition-all duration-300 text-center md:text-left pt-4">
      {{ value }}
    </div>
  </div>
</template>
